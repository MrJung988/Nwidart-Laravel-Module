        ...
        <form action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="container">
                <div class="row mt-2">
                    ...
                    <div class="col-6 mt-3">
                        <input type="text" class="form-control" name="company_slogan" placeholder="Enter company slogan">
                        <span class="text-danger small">
                    ...
                    <div class="col-6 mt-3">
                        <input type="text" class="form-control" name="company_url" placeholder="Enter company url">
                        <span class="text-danger small">
                            @error('company_url')
                                {{ $message }}
                            @enderror
